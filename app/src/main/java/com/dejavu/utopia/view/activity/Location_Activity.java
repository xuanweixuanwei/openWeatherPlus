...
import com.dejavu.utopia.utils.Utils;
...
public class Location_Activity extends CheckPermissionsActivity
	...
	private void initLocation(){
		...
		if (null==locationClient) {
			tvResult.setText("kkkkkkkkkkk"
			);
		}
	}
	private void privacyCompliance() {
		MapsInitializer.updatePrivacyShow(Location_Activity.this,true,true);
		...
		new AlertDialog.Builder(this)
				...
				.setPositiveButton("同意", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialogInterface, int i) {
						MapsInitializer.updatePrivacyAgree(Location_Activity.this,true);
				...
				.setNegativeButton("不同意", new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface dialogInterface, int i) {
						MapsInitializer.updatePrivacyAgree(Location_Activity.this,false);
					}
				})
				.show();
	}
